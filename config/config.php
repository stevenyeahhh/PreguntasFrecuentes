...
define('ROOT', $_SERVER['DOCUMENT_ROOT'] . DS .'frequestion'.DS);
define('DEFAULT_LAYOUT', 'default');
define('BASE', 'http://' . $_SERVER['SERVER_NAME'].'/frequestion/' );
...
define("DB_ROUTE","mysql:host=sweetmemoriestudio.com;dbname=frequestion");
